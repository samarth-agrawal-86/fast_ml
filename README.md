...
## Fast-ML is a Python package with numerous inbuilt functionalities to make the life of data scientist much easier
...
### Usage
```python
from fast_ml.fast_ml.feature_engineering import FeatureEngineering_Categorical
import pandas as pd
